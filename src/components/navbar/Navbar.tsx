  ...
  return (
    <nav className=" p-10 w-full">
      <div className=" flex items-center justify-between w-full ">
        <div className=" flex flex-row items-center justify-start space-x-10 w-min">
          <Link href="/" className="flex flex-row  items-center space-x-6">
            <Image
              ...
              alt="Logo"
            />
            <span className={`   text-lime-500 text-xl tracking-widest glow ${pacifico.className}`}>Medhashis portfolio</span>
          </Link>
